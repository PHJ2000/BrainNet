...
def upgrade() -> None:
    ...
    sa.Column('authors', sa.BigInteger(), nullable=True),
    sa.Column('content', sa.Text(), nullable=False),
    sa.Column('status', sa.Enum('GHOST', 'ACTIVE', 'ARCHIVED', name='node_state_t'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['authors'], ['app_user.id'], ),
